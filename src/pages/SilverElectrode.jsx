...
export default function SilverElectrode() {
  ...
  const meusLinks = [
    ...
    { title: 'Acompanhamento Mensal', link: 'https://app.powerbi.com/groups/26c107da-94ff-4b8f-9de4-1da4f23fea94/reports/a2602571-dc69-4748-95f1-c8e3108404b9/796010f0104d02cb1db4?experience=power-bi', relevance: 1 }
];
