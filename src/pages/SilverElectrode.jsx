...
export default function SilverElectrode() {
  ...
  const meusLinks = [
    ...
    { title: 'Previsão de cosnumo', link: 'https://app.powerbi.com/groups/26c107da-94ff-4b8f-9de4-1da4f23fea94/reports/2683a480-7446-4223-bcdf-44631fd9ec34/078bbcf405002d835c20?experience=power-bi', relevance: 1 },
  ];
